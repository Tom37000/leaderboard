import './LeaderBoardXinouCup.css';
            ...
            if (previousLeaderboard) {
                ...
                updatedLeaderboardData = allLeaderboardData.map(team => {
                    ...
                    return {
                        ...
                        hasPositionChanged: indicatorVal !== 0,
...
export default LeaderBoardXinouCup
