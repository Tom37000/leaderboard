...
function LeaderboardCoupeDeFrance() {
    ...
    const loadLeaderboard = React.useCallback(async () => {
        try {
            ...
            if (previousLeaderboardRef.current) {
                const previousTeamsMap = new Map(previousLeaderboardRef.current.map(team => [team.teamname, team]));
            ...
            previousLeaderboardRef.current = updatedLeaderboardData;
        } catch (error) {
            console.error('Error loading leaderboard data:', error);
        }
    }, [leaderboard_id, isInitialLoad]);
        ...
        <div className='cdf'>
            <div className='leaderboard_container'>
                ...
                <div className='leaderboard_title' style={{
                    ...
                    marginBottom: '20px',
                    fontWeight: 'bold'
                }}>Classement | Coupe De France</div>
